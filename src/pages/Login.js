    ...
    <div style={{
      ...
      <div style={{width:'100%', maxWidth:'400px'}}>
        <div style={{textAlign:'center', marginBottom:'32px'}}>
          ...
          <div style={{fontSize:'22px', fontWeight:800, color:'#fff', marginBottom:'6px'}}>Open Championship Golf Pool</div>
          <div style={{fontSize:'14px', color:'var(--text-muted)'}}>2026 Open Championship — Bill vs Don</div>
        </div>
